...
class MaskDecoder(nn.Module):
    ...
    def predict_masks(
        ...
        new_output_tokens: torch.Tensor, # b 5 256
    ) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        tokens = torch.cat((new_output_tokens, sparse_prompt_embeddings), dim=1) # only cat with sparse_prompt # b 7 256 when sparse_prompt point is 2
